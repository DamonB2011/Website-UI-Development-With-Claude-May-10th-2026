...
const FoodScene3D = dynamic(() => import("@/components/ui/FoodScene3D"), { ssr: false });
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center min-h-[calc(100vh-5rem)]">
          ...
          >
            ...
            {/* Circular 3D scene frame */}
            <div className="relative w-[460px] h-[460px]">
              <div className="absolute inset-0 rounded-full overflow-hidden">
                <FoodScene3D dish="risotto" className="w-full h-full" />
              </div>
              {/* Rim */}
              ...
              >
                <div className="w-7 h-7 rounded-full bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-xs font-bold text-amber-400">L</div>
                <div>
